...
#include "../../../dppp/Source/SoundAnalyzer/csettings.h"
...
QT_MOC_LITERAL(3, 19, 14), // "getValueForKey"
QT_MOC_LITERAL(4, 34, 3), // "key"
QT_MOC_LITERAL(5, 38, 14), // "setValueForKey"
QT_MOC_LITERAL(6, 53, 5) // "value"

    },
    "CSettings\0updated\0\0getValueForKey\0key\0"
    "setValueForKey\0value"
};
...
static const uint qt_meta_data_CSettings[] = {
 ...
 // methods: parameters
    ...
    QMetaType::Void, QMetaType::QString, QMetaType::QVariant,    4,    6,
...
void CSettings::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: { QVariant _r = _t->getValueForKey((*reinterpret_cast< QString(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< QVariant*>(_a[0]) = _r; }  break;
        case 2: _t->setValueForKey((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QVariant(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (CSettings::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CSettings::updated)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject CSettings::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_CSettings.data,
